...
@keyframes legStepL{0%,100%{transform:rotate(-22deg)}50%{transform:rotate(22deg)}}
@keyframes legStepR{0%,100%{transform:rotate(22deg)}50%{transform:rotate(-22deg)}}
...
teddy.id='teddy';
teddy.innerHTML=`
<svg id="teddy-svg" width="170" height="210" viewBox="0 0 170 210" style="overflow:visible">
  <defs>
    <!-- main body skin: warm cream white -->
    <radialGradient id="skinGrad" cx="38%" cy="30%" r="75%">
      <stop offset="0%" stop-color="#fff9f0"/>
      <stop offset="60%" stop-color="#fff3e4"/>
      <stop offset="100%" stop-color="#f5dfc8"/>
    </radialGradient>
    <!-- belly lighter patch -->
    <radialGradient id="bellyGrad" cx="40%" cy="35%" r="70%">
      <stop offset="0%" stop-color="#ffffff"/>
      <stop offset="100%" stop-color="#fff0e0"/>
    </radialGradient>
    <!-- left eye gradient for depth -->
    <radialGradient id="eyeL" cx="35%" cy="30%" r="65%">
      <stop offset="0%" stop-color="#6b3fa0"/>
      <stop offset="55%" stop-color="#2d1a5e"/>
      <stop offset="100%" stop-color="#1a0a3a"/>
    </radialGradient>
    <!-- right eye gradient -->
    <radialGradient id="eyeR" cx="35%" cy="30%" r="65%">
      <stop offset="0%" stop-color="#6b3fa0"/>
      <stop offset="55%" stop-color="#2d1a5e"/>
      <stop offset="100%" stop-color="#1a0a3a"/>
    </radialGradient>
    <!-- ear inner pink -->
    <radialGradient id="earPink" cx="45%" cy="40%" r="65%">
      <stop offset="0%" stop-color="#ffcfe0"/>
      <stop offset="100%" stop-color="#ffaac6"/>
    </radialGradient>
    <!-- cheek blush -->
    <radialGradient id="blushGrad" cx="50%" cy="50%" r="60%">
      <stop offset="0%" stop-color="#ff9eb8" stop-opacity=".8"/>
      <stop offset="100%" stop-color="#ff7aab" stop-opacity=".2"/>
    </radialGradient>
    <!-- drop shadow filter -->
    <filter id="softShadow" x="-20%" y="-10%" width="140%" height="140%">
      <feDropShadow dx="0" dy="4" stdDeviation="5" flood-color="rgba(0,0,0,.18)"/>
    </filter>
  </defs>

  <!-- ground shadow -->
  <ellipse cx="85" cy="206" rx="48" ry="7" fill="rgba(0,0,0,.14)"/>

  <!-- ══ LEGS — short stubby, same width top to bottom ══ -->
  <g id="leg-left" style="transform-origin:60px 182px">
    <rect x="46" y="168" width="28" height="30" rx="14" fill="url(#skinGrad)" stroke="#e8cdb0" stroke-width="2"/>
    <!-- little foot -->
    <ellipse cx="60" cy="198" rx="17" ry="9" fill="url(#skinGrad)" stroke="#e8cdb0" stroke-width="1.8"/>
  </g>
  <g id="leg-right" style="transform-origin:110px 182px">
    <rect x="96" y="168" width="28" height="30" rx="14" fill="url(#skinGrad)" stroke="#e8cdb0" stroke-width="2"/>
    <ellipse cx="110" cy="198" rx="17" ry="9" fill="url(#skinGrad)" stroke="#e8cdb0" stroke-width="1.8"/>
  </g>

  <!-- ══ BODY — chubby rounded rectangle, Soso style ══ -->
  <rect x="34" y="118" width="102" height="72" rx="38" fill="url(#skinGrad)"
    stroke="#e8cdb0" stroke-width="2.5" filter="url(#softShadow)"/>
  <!-- belly highlight -->
  <ellipse cx="85" cy="148" rx="30" ry="24" fill="url(#bellyGrad)" opacity=".85"/>

  <!-- ══ ARMS — tiny round nubs, signature Soso/Jojo style ══ -->
  <g id="larm" style="transform-origin:38px 132px">
    <!-- upper arm -->
    <circle cx="38" cy="130" r="14" fill="url(#skinGrad)" stroke="#e8cdb0" stroke-width="2"/>
    <!-- little hand nub -->
    <circle cx="26" cy="148" r="12" fill="url(#skinGrad)" stroke="#e8cdb0" stroke-width="1.8"/>
  </g>
  <g id="rarm" style="transform-origin:132px 132px">
    <circle cx="132" cy="130" r="14" fill="url(#skinGrad)" stroke="#e8cdb0" stroke-width="2"/>
    <circle cx="144" cy="148" r="12" fill="url(#skinGrad)" stroke="#e8cdb0" stroke-width="1.8"/>
  </g>

  <!-- ══ HEAD — oversized circle, ~60% of total height, very Soso/Jojo ══ -->
  <circle cx="85" cy="76" r="64" fill="url(#skinGrad)"
    stroke="#e8cdb0" stroke-width="2.8" filter="url(#softShadow)"/>

  <!-- ══ EARS — round, sit on the very top edge of the head ══ -->
  <circle cx="36" cy="28" r="20" fill="url(#skinGrad)" stroke="#e8cdb0" stroke-width="2.2"/>
  <circle cx="36" cy="28" r="11" fill="url(#earPink)"/>
  <circle cx="134" cy="28" r="20" fill="url(#skinGrad)" stroke="#e8cdb0" stroke-width="2.2"/>
  <circle cx="134" cy="28" r="11" fill="url(#earPink)"/>

  <!-- ══ EYES — huge filled circles with multiple shine dots, very Soso ══ -->
  <g id="eyes">
    <!-- left eye -->
    <circle cx="62" cy="72" r="16" fill="url(#eyeL)"/>
    <circle cx="62" cy="72" r="12" fill="#1e0e44"/>
    <!-- main shine -->
    <circle cx="55" cy="64" r="5.5" fill="white"/>
    <!-- small secondary shine -->
    <circle cx="68" cy="68" r="2.5" fill="rgba(255,255,255,.7)"/>
    <!-- right eye -->
    <circle cx="108" cy="72" r="16" fill="url(#eyeR)"/>
    <circle cx="108" cy="72" r="12" fill="#1e0e44"/>
    <circle cx="101" cy="64" r="5.5" fill="white"/>
    <circle cx="114" cy="68" r="2.5" fill="rgba(255,255,255,.7)"/>
  </g>

  <!-- closed eyes (sleeping) — curved lines like Soso sleeping -->
  <g id="eyes-closed" style="display:none">
    <path d="M46,72 Q62,82 78,72" fill="none" stroke="#5a3a6a" stroke-width="3.5" stroke-linecap="round"/>
    <path d="M92,72 Q108,82 124,72" fill="none" stroke="#5a3a6a" stroke-width="3.5" stroke-linecap="round"/>
    <!-- little zzz effect dots -->
    <circle cx="46" cy="69" r="2" fill="#c8b4e8" opacity=".6"/>
    <circle cx="124" cy="69" r="2" fill="#c8b4e8" opacity=".6"/>
  </g>

  <!-- eyes-down for laptop state — pupils shifted downward -->
  <g id="eyes-down" style="display:none">
    <circle cx="62" cy="72" r="16" fill="url(#eyeL)"/>
    <circle cx="62" cy="76" r="12" fill="#1e0e44"/>
    <circle cx="56" cy="70" r="5.5" fill="white"/>
    <circle cx="108" cy="72" r="16" fill="url(#eyeR)"/>
    <circle cx="108" cy="76" r="12" fill="#1e0e44"/>
    <circle cx="102" cy="70" r="5.5" fill="white"/>
  </g>

  <!-- eyebrows — short, gentle arcs above the eyes -->
  <path d="M49,51 Q62,45 75,50" fill="none" stroke="#c8a88a" stroke-width="3" stroke-linecap="round"/>
  <path d="M95,50 Q108,45 121,51" fill="none" stroke="#c8a88a" stroke-width="3" stroke-linecap="round"/>

  <!-- cheek blushes — large heart-shaped like Soso/Jojo -->
  <ellipse cx="38" cy="90" rx="16" ry="11" fill="url(#blushGrad)"/>
  <ellipse cx="132" cy="90" rx="16" ry="11" fill="url(#blushGrad)"/>

  <!-- tiny button nose — just a small oval like Soso -->
  <ellipse cx="85" cy="95" rx="6" ry="4.5" fill="#e8a898"/>

  <!-- mouth — big warm W-shaped smile like Soso/Jojo -->
  <path id="mouth" d="M65,106 Q75,118 85,111 Q95,118 105,106"
    fill="none" stroke="#c87860" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"/>
  <!-- tiny tongue peeking out -->
  <ellipse cx="85" cy="114" rx="7" ry="5" fill="#ff8fa0" opacity=".8"/>

  <!-- blush sparkle dots for extra cuteness -->
  <circle cx="28" cy="86" r="1.5" fill="#ffb3cc" opacity=".7"/>
  <circle cx="33" cy="80" r="1" fill="#ffb3cc" opacity=".5"/>
  <circle cx="142" cy="86" r="1.5" fill="#ffb3cc" opacity=".7"/>
  <circle cx="137" cy="80" r="1" fill="#ffb3cc" opacity=".5"/>
</svg>

<!-- Lollipop (visible in walking/idle states) -->
<div id="teddy-lollipop" style="position:absolute;right:-16px;top:4px;z-index:30">
  <svg width="52" height="84" viewBox="0 0 48 80" style="overflow:visible">
...
<div id="teddy-laptop" style="position:absolute;left:18px;bottom:18px;display:none;z-index:30">
  <svg width="70" height="50" viewBox="0 0 70 50">
    ...
    <!-- screen content: little video bars -->
